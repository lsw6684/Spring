...
## 싱글톤
스프링은 기업용 온라인 서비스 기술 지원에 특화되어 있으며, 여러 Client의 요청이 동시에 발생하곤 합니다. Client 요청 마다, 객체 인스턴스를 생성하면 *극심한 메모리 낭비를 초래*하기 때문에, **인스턴스를 1개만 생성하여 공유**하는 **싱글톤 디자인 패턴**을 지향해야 합니다.
